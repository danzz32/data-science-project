...
O projeto utiliza a base de dados abertos da Polícia Rodoviária Federal (PRF), escolhida pela sua expressiva riqueza de variáveis físicas, temporais e geográficas (latitude e longitude nativas). O foco analítico principal deste estudo está no recorte regional do estado do Maranhão, buscando extrair *insights* sobre a dinâmica dos acidentes de trânsito na região.
<div>

## 🛠 Pré-requisitos

<div align="justify">
Para gerenciar as dependências e o ambiente virtual deste projeto de forma performática, utilizamos o __uv__ , um instalador e gerenciador de pacotes Python extremamente rápido escrito em Rust.
<div>
